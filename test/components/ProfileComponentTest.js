...
describe('ProfileComponentTest', function () {
    it('test append method', function () {
        ...
        const expectedHTML = '<h2 class="subtitle is-4">Profile</h2><div class="profile"><div class="media"><div class="media-left"><figure class="media-left image is-64x64"><img id="profile-image" src="https://fakeadress.com/avatar.png"></figure></div><div class="media-left"><div class="title is-5" id="profile-name">baboon</div><div class="subtitle is-6"><a href="https://fakeadress.com/index.html" id="profile-url">@baboonX</a></div><div class="content wrap" id="profile-bio"><p>I\'r baboon</p></div></div></div></div>';
